...
if option == "1":
    ...
    year = input("Enter year between 1999 to 2012:\n")
    with open("sentiment-score.json", "r") as f:
        text = f.read()
    insight_dict = json.loads(text)
    xAxis = ["Positive", "Negative", "Neutral"]
    yAxis_s = [insight_dict[year]["summary_score_positive_count"],
               insight_dict[year]["summary_score_negative_count"],
               insight_dict[year]["summary_score_neutral_count"]]
    yAxis_t = [insight_dict[year]["text_score_positive_count"],
               insight_dict[year]["text_score_negative_count"],
               insight_
...
![Alt text](https://github.com/riddhi-99/AmazonFoodReviewSentimentAnalysis/blob/main/image.png)
